...
//  I have altered this file to load my own test asm file. I will alter this file for every asm file I need to test

load MemoryAccessTemp.asm,   //  This file must not contain _ unless it will throw. NOTE: Always rename to the asm file you want to test
